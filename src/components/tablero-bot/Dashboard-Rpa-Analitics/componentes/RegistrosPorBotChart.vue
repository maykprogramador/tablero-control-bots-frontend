  ...
  <div class="bg-white dark:bg-slate-800 dark:border dark:border-slate-700 rounded-2xl shadow-lg p-6">
    ...
    <div class="flex justify-between items-center mb-4">
      ...
      <button
        ...
        class="flex items-center gap-2 px-4 py-2  bg-gray-100 text-gray-700 dark:text-white  dark:bg-slate-700  rounded-lg  hover:bg-gray-200  dark:hover:bg-slate-600 transition-all shadow-sm hover:shadow-md  dark:shadow-slate-900/50" >
