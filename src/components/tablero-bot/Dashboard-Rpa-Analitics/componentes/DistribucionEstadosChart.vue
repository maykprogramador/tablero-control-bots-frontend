  ...
  <div class="bg-white shadow rounded-xl p-6">
    ...
    <div class="flex items-start justify-between mb-4">
      ...
      <div class="relative">
        <select
          ...
          class="w-36 appearance-none text-sm bg-white border border-slate-300 rounded-lg pl-3 pr-10 py-2 
                text-slate-700 font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500 
    ...
    <div class="relative w-full flex justify-center items-center" style="height: 260px;">
      ...
      <div class="absolute flex flex-col items-center justify-center">
        <p class="text-4xl font-bold text-slate-700">
          {{ porcentajeEficiencia }}%
        </p>
        <p class="text-xs tracking-wide text-gray-400">EFICIENCIA</p>
      </div>
    </div>
...
const cargarDistribucion = async () => {
  ...
  //console.log('botseleccionadoi: ', botSeleccionado.value);
