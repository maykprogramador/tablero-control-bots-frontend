      ...
      <div class="bg-white rounded-2xl shadow-2xl p-8":class="{ 'animate-pulse': isLoading }">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-4xl font-semibold tracking-tight">
            ...
            <span class="bg-[#80006A] text-white text-sm font-bold rounded px-2 py-0.5 ml-1 align-top">SGB</span>
          </h1>

          <!-- Subtítulo -->
          <p class="text-gray-700 text-base mt-2 font-medium">Inicie sesión con su cuenta</p>
        </div>
